const opdrachten = [
    {
        titel: "Hang de vlag uit",
        plaatje: "./images/vlaggen.jpg",
        ...
        programma: ["html", "css"],
        tekst: "Dit was de eerste opdracht die nagekeken werd. Deze website is alleen met HTML en CSS gemaakt, en moest onderdelen als grid, flexbox en mediaqueries bevatten."
    },
    {
        titel: "Benno het Bernertje",
        plaatje: "./images/benno.jpg",
        website: "https://benno-test-kankervaccin.netlify.app/",
        github: "https://github.com/sandermeijer1972/benno",
        programma: ["html", "css"],
        tekst: "Onze hond doet mee aan een onderzoek naar een vaccin tegen kanker. Omdat we daar veel vragen over kregen (en nog steeds krijgen) heb ik daar een pagina voor gemaakt, met daarop het hele verhaal. Gemaakt met HTML en CSS."
    },
    {
        titel: "Kleurentoggle",
        plaatje: "./images/kleurentoggle.jpg",
        website: "https://hungry-ptolemy-2e50ff.netlify.app/",
        github: "https://github.com/sandermeijer1972/Sander_Meijer-Kleurentoggle",
        programma: ["html", "css", "javascript"],
        tekst: "De eerste grotere opdracht met JavaScript. Hierbij moest gebruik worden gemaakt van DOM-manipulatie. Met behulp van event-listeners moesten er classes toegevoegd en verwijderd worden. Met transities moest het er wat flitsender uitzien allemaal."
    },
    {
        titel: "Filmzoeker",
        plaatje: "./images/filmzoeker.jpg",
        website: "https://admiring-goldberg-8a03d3.netlify.app/",
        github: "https://github.com/sandermeijer1972/Sander_Meijer-filmzoeker",
        programma: ["html", "css", "javascript"],
        tekst: "Bij deze opdracht moest je elementen toevoegen aan de DOM. Alle data stond in een database, en daar moest je ook wat dingen uit filteren."
    },
    {
        titel: "1000-footers",
        plaatje: "./images/greatlakes.jpg",
        website: "https://great-lakes-1000footers.netlify.app/",
        github: "https://github.com/sandermeijer1972/GreatLakes",
        programma: ["html", "css", "javascript"],
        tekst: "Nadat ik een tijdje bezig was met React, heb ik voor mezelf nog een website gemaakt met Vanilla JavaScript. Het is de bedoeling dat ik deze zelfde website ook nog ga maken met React."
    },
    {
        titel: "Grote Database",
        plaatje: "./images/database.jpg",
        website: "https://romantic-thompson-cbba2b.netlify.app/",
        github: "https://github.com/sandermeijer1972/grote_arrays",
        programma: ["html", "css", "javascript"],
        tekst: "Bij deze opdracht zat een hele grote database. Voor elke sub-opdracht moest je gaan filteren om de juiste gegevens door middel van DOM-manipulatie op de pagina te krijgen. Je leerde hier veel over array-methods, en dan met name map, filter en reduce."
    },
    {
        titel: "Advent of Code",
        plaatje: "./images/advent.jpg",
        website: "https://adventofcode.com/2021",
        github: "https://github.com/sandermeijer1972/Advent_of_Code_2021",
        programma: ["javascript"],
        tekst: "Vanuit Winc Academy werd je aangemoedigd om aan de jaarlijkse Advent of Code mee te doen. Ik ben er fanatiek aan begonnen, maar merkte al snel dat er wel heel veel tijd in ging zitten. Dus daarna mezelf de opdracht gegeven om tot uiterlijk 11 uur er mee bezig te zijn, en daarna 's avonds pas weer. Niet alle puzzels waren te doen, dus ik kan er nog verder aan coderen."
    },
    {
        titel: "API-fun",
        plaatje: "./images/apifun.jpg",
        website: "https://knoppen-pagina.netlify.app/",
        github: "https://github.com/sandermeijer1972/API_fun",
        programma: ["html", "css", "javascript"],
        tekst: "Bij deze opdracht moest je je data via een API binnen zien te krijgen. Omdat ik moeite had met deze stof, heb ik er uiteindelijk 10 gebruikt. Bij Winc Academy word je ook gestimuleerd om anderen te helpen met coderings-problemen. Op het moment dat ik met deze opdracht bezig was, hielp ik iemand met transities. Omdat die stof bij mij ook aardig weggezakt was, heb ik dat bij deze opdracht weer eens flink opgehaald."
    },
    {
        titel: "To-Do List",
        plaatje: "./images/todolist.jpg",
    ...
    {
        titel: "TDD Groentetuin",
        plaatje: "./images/groentetuin.jpg",
        website: "https://sanders-groentetuin.netlify.app/",
        github: "https://github.com/sandermeijer1972/Sander_Meijer-TDD_groentetuin",
        programma: ["html", "css", "javascript", "jest"],
        tekst: "Bij deze opdracht ging het om Test Driven Development. Omdat ik graag aan anderen wil laten zien wat ik zoal maak tijdens de opleiding, heb ik er ook een hele front-end aan vast gemaakt. Je kan dus zelf een groentetuin beginnen, en een schatting maken wat je opbrengst zal zijn."
    },
    {
        titel: "React",
        plaatje: "./images/react.jpg",
        ...
        programma: ["react", "css"],
        tekst: "Bij het leren van React, kreeg je steeds korte lessen, met veel verschillende kleine opdrachten. Omdat je het met Scrimba leerde, sloeg je je eigen code eigenlijk niet op. Daarom heb ik wat van die opdrachten daarna ook nog gewoon in Visual Studio Code gemaakt, en er een menu bij gemaakt. Dit was nog voordat ik het Router-principe leerde in React."
    },
    {
        titel: "Boodschappenlijstje",
        plaatje: "./images/boodschappen.jpg",
        ...
        programma: ["react", "css"],
        tekst: "De eerste react-opdracht die je in Visual Studio Code moest maken. Een erg leuke opdracht, maar wel moeilijk."
    },
    {
        titel: "Playlist",
        plaatje: "./images/playlist.jpg",
        website: "https://sanders-playlist.netlify.app/",
        github: "https://github.com/sandermeijer1972/Sander_Meijer-Lil-Playlist",
        programma: ["react", "css"],
        tekst: "Bij deze opdracht moest je ook gebruik maken van React-Router. Omdat het een opdracht met muziek was, was dit echt een hele leuke opdracht."
    },
    {
        titel: "Portfolio",
